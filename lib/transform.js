...
function setIsExportedFlag (identifier) {
  const isNamedExport = /^exports\./.test(identifier.meta.code.name) && identifier.kind !== 'module'
  const isDefaultExport = /module:/.test(identifier.name) && identifier.kind !== 'module' && identifier.kind !== 'constructor';
  
  if (isNamedExport || isDefaultExport) {
    identifier.isExported = true
    identifier.scope = 'exports'
